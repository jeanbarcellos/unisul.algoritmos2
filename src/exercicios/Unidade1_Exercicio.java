...
public class Unidade1_Exercicio {
    
    public static void main(String args[]){
    
        int A[][] = new int[3][3]; // Matriz de Distâncias
        ...
        /*for(l=0; l<raiz; l++){
            for(c=0; c<raiz; c++){
                A[l][c] = Integer.parseInt(JOptionPane.showInputDialog("Informe um valor para linha "+i+" e coluna "+j+": "));
                qtd++;
            }
        }*/
        A[0][0] = 4;
        ...
        for(l=0; l<raiz; l++){
            for(c=0; c<raiz; c++){
				if(l==c){
					resultado_l = resultado_l + A[l][c]; // posso fazer esta soma direto no exercicio i
				}
            }
        }
