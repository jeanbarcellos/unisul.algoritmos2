...
public class Trabalho3 {
    ...
    static final String DB_ARQUIVO = "dados.txt";
    ...
    {  
        ...
        try {
            ...
            db = new BufferedWriter(new FileWriter(new File(DB_ARQUIVO)));
            ...
            for (int i = 0; i < QUANTIDADE_ATUAL; i++) {
                ...
                "" + PRODUTOS[i].lucro + ";"+
                "" + PRODUTOS[i].fornecedor.razao_social + ";"+
                "" + PRODUTOS[i].fornecedor.endereco + ";"+
                "" + PRODUTOS[i].fornecedor.cidade + ";"+
                "" + PRODUTOS[i].fornecedor.estado + "\n";
    ...
    public static void lerArquivo()
    {
        ...
        try {
            BufferedReader db = new BufferedReader(new FileReader(new File(DB_ARQUIVO)));
            ...
            while (linha!= null) {
                ...
                PRODUTOS[i] = new Produto();
                PRODUTOS[i].descricao = dado[0];
                PRODUTOS[i].quantidade = Integer.parseInt(dado[1]);
                PRODUTOS[i].preco_custo = Double.parseDouble(dado[2]);
                PRODUTOS[i].lucro = Double.parseDouble(dado[3]);
                PRODUTOS[i].fornecedor.razao_social = dado[4];
                PRODUTOS[i].fornecedor.endereco = dado[5];
                PRODUTOS[i].fornecedor.cidade = dado[6];
                PRODUTOS[i].fornecedor.estado = dado[7];
